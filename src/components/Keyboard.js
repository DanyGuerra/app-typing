    ...
    <KeyboardWrapper viewBox="0 0 338 120">
      <g id="pinky-rigth">
        ...
        <g id="key-backspace">
          <path
            id="rect-Backspace"
            className={`st0 ${actualKey === "Backspace" ? "key-active" : ""}`}
        ...
        <g id="key-backslash">
          <path
            id="rect-Backslash"
            className={`st0 ${actualKey === "Backslash" ? "key-active" : ""}`}
        ...
        <g id="key-rshift">
          <path
            id="rect-ShiftRight"
            className={`st0 ${actualKey === "ShiftRight" ? "key-active" : ""}`}
        ...
        <g id="key-alt-gr">
          <path
            id="rect-AltRight"
            className={`st0 ${actualKey === "AltRight" ? "key-active" : ""}`}
      ...
      <g id="pinky-left">
        ...
        <g id="key-caps-lock">
          <path
            id="rect-CapsLock"
            className={`st0 ${actualKey === "CapsLock" ? "key-active" : ""}`}
        ...
        <g id="key-lshift">
          <path
            id="rect-ShiftLeft"
            className={`st0 ${actualKey === "ShiftLeft" ? "key-active" : ""}`}
        ...
        <g id="key-left-control">
          <path
            id="rect-ControlLeft"
            className={`st0 ${actualKey === "ControlLeft" ? "key-active" : ""}`}
